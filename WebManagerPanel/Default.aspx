    ...
    <form>
        <div id="application">
                ...
                <div class="cq-main-header-wrapper">
                    <div class="container">
                        <div class="row">
                            ...
                            <div id="commandIndicator" class="col-xs-3 col-md-2 cq-header-item">
                                <section class="cq-busy" style="display: none;">
                                    <div class="cq-busy-image">
                                        <img src="/Images/loading.gif">
                                    </div>
                                    <div id="currentCommand" class="cq-current-command">Loading scheduler data</div>
                                </section>
                            </div>
                            ...
                            <div class="col-sm-12 col-md-5">
                                <table class="cq-info-table">
                                    ...
                                    <tbody>
                                        <tr>
                                            <th>Running since:</th>
                                            <td class="runningSince"><%=SchedulerInfo.Data.RunningSince %></td>
                                        </tr>
                                        <tr>
                                            <th>Total Jobs:</th>
                                        ...
                                        <tr>
                                            <th>Executed Jobs:</th>
                                            <td class="executedJobs"><%=SchedulerInfo.Data.JobsExecuted %></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            <div class="col-sm-12 col-md-5">
                                <table class="cq-info-table">
                                    ...
                                    <tbody>
                                        <tr>
                                            <th>Name:</th>
                                            <td class="schedulerName"><%=SchedulerInfo.Data.SchedulerName %></td>
                                        </tr>
                                        <tr>
                                            <th>Instance ID:</th>
                                            <td class="instanceId"><%=SchedulerInfo.Data.InstanceId %></td>
                                        </tr>
                                        <tr>
                                            <th>Is remote:</th>
                                            <td class="isRemote"><%=SchedulerInfo.Data.IsRemote %></td>
                                        </tr>
                                        <tr>
                                            <th>Scheduler type:</th>
                                            <td class="schedulerType"><%=SchedulerInfo.Data.SchedulerType %></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
            ...
            <div class="container" style="margin-top: 250px">
                <%foreach (var item in SchedulerInfo.Data.JobGroups)
                  {%>
                    ...
                    <section class="content">
                        ...
                        <article class="cq-job">
                            <header class="cq-job-header clearfix">
                                ...
                                <a class="cq-job-header-title loadDetails name" href="#"><%=item1.GroupName  %></a>
